...
Go and generate a widget stub.
  ...
  $ rails generate apotomo:widget Comments display write -e haml
    ...
    create  app/assets/javascripts/widgets/comments_widget.js.coffee
    create  test/widgets/comments_widget_test.rb

Nothing special. Go and generate a widget TopBar stub.

  $ rails generate apotomo:widget TopBar display -e haml
    create  app/widgets/top_bar_widget.rb
    create  app/widgets/top_bar/display.html.haml
    create  app/assets/stylesheets/widgets/top_bar_widget.css
    create  app/assets/javascripts/widgets/top_bar_widget.js.coffee
    create  test/widgets/top_bar_widget_test.rb

And a Form widget within the TopBar namespace.

  $ rails generate apotomo:widget TopBar::Form display -e haml
    create  app/widgets/top_bar/form/form_widget.rb
    create  app/widgets/top_bar/form/display.html.haml
    create  app/assets/javascripts/widgets/top_bar/form_widget.js.coffee
    create  app/assets/stylesheets/widgets/top_bar/form_widget.css
    create  test/widgets/top_bar/form/form_widget_test.rb
...
Rendering usually happens in your controller view, <tt>views/posts/display.html.haml</tt>, for instance.
...
This ensures that all our javascript for a widget is nicely namespace contained (based on [namespace.js.coffee](https://github.com/CodeCatalyst/namespace.js.coffee)).
...
In the +app/assets/javascripts/widgets/top_bar.js.coffee+ file the following is generated for our convenience.
When you generate a widget, the coffescript file for it should look like this:
...
Let's use nested namespaces!

  rails g apotomo:widget TopBar::SuperThang display -e haml

Then write to your +app/assets/javascripts/widgets/top_bar/super_thang_widget.js.coffee+:
...
Note that you can use jQuery [extend](http://api.jquery.com/jQuery.extend/) to extend javascript widget functionality similar to modules (prototypical inheritance). 
