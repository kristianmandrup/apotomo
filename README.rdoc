...
This ensures that all our javascript for a widget is nicely namespace contained (based on [namespace.coffee](https://github.com/CodeCatalyst/namespace.coffee)).
...
In the +app/assets/javascripts/widgets/top_bar.coffee+ file the following is generated for our convenience.
When you generate a widget, the coffescript file for it should look like this:
...
Then write to your +app/assets/javascripts/widgets/top_bar/super_thang_widget.coffee+:
